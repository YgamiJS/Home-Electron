    ...
    createRoutesFromElements(
      ...
      >
        ...
        <Route
          path="/Home/articles"
          element={
            <Articles posts={posts} setPosts={setPosts} setStateDataPost={setStateDataPost} />
          }
        ></Route>
        <Route
          path="/Home/currentArticle"
          element={<CurrentArticle posts={posts} stateDataPost={stateDataPost} />}
        ></Route>
        <Route
          ...
          element={
            <New
              settings={{
                ...
                urlFetch: 'https://jsonplaceholder.typicode.com/posts',
                urlLink: 'articles',
                data: posts,
                setData: setPosts,
                inputsName: {
        ...
        <Route
          path="/Home/qa"
          element={<Qa stateQuestion={stateQuestion} stateQuestions={stateQuestions} />}
        ></Route>
        <Route
          ...
          element={
            <New
              settings={{
                ...
                urlFetch: 'https://jsonplaceholder.typicode.com/comments',
